...
export const MUST_LEAK = [
  ...
  },
  {
    ...
    value: 'jane-win',
    why: 'leak 3 as it shipped ("jane-win"). The whole username does not appear in it, so a full-name substring test scans it clean. The label here is the FICTIONAL operator, not the real one: the real one sat in this field until 2026-09-17, and a provenance note is not an exemption from the guard this file is scanned by',
  },
  {
    what: 'hostname',
